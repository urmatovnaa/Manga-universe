...
from apps.title_app.models import Tag, Genre, Title, TitleStatus, AdultContent, \
    TranslatorStatus, TitleType, ReleaseFormat


class TitleFilter(filters.FilterSet):
    """ TitleList filters """
    genres = filters.ModelMultipleChoiceFilter(queryset=Genre.objects.all(), widget=CheckboxSelectMultiple(),
                                               label="Жанры")
