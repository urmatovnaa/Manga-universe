...
from apps.info_section_app.models import SimilarLike, SimilarDislike, Favorite
from apps.info_section_app.serializers import SimilarCreateSerializer, RelatedCreateSerializer, \
    FavoriteSerializer
